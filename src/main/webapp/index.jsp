...
<body>
  ...
  <nav class="navbar navbar-expand-sm container my-3">
    ...
    <div class="collapse navbar-collapse" id="my-navbar">
      ...
      <a id="call" href="tel:9555161307"><i class="fa-solid fa-mobile-screen-button"></i> 9555161307</a>
    </div>
  </nav>
  ...
  <section class="container p-4">
    ...
    <p class="text-secondary">Whether you're planning a weekend getaway or a cross-country road trip, our commitment to providing quality vehicles at low prices ensures that you can focus on enjoying the ride without worrying about excessive expenses. Experience the convenience and affordability of renting a car with us today.</p>
  </section>
      ...
      <div class="row">
        <div class="col-sm p-2">
          <div class="c-dishes-card">
            ...
            <h6>Drive and explore.</h6>
            <p>Take the wheel and journey forward with freedom and control.</p>
          </div>
        </div>
        <div class="col-sm p-2">
          <div class="c-dishes-card">
            <img src="resources/img2.jpg" alt="">
            <h6>Let's embark on an adventure</h6>
            <p>Let's begin a thrilling journey filled with excitement and discovery..</p>
          </div>
        </div>
        <div class="col-sm p-2">
          <div class="c-dishes-card">
            <img src="resources/img3.jpg" alt="">
            <h6>Glimpse of the Trip.</h6>
            <p>Capture fleeting moments that paint the vivid canvas of our journey.</p>
          </div>
        </div>
        <div class="col-sm p-2">
          <div class="c-dishes-card">
            <img src="resources/img4.jpg" alt="">
            <h6>Book and make a Trip.</h6>
            <p>Secure your seat and set the course for unforgettable adventures ahead.</p>
          </div>
        </div>
      </div>
  ...
  <section id="sec-1" class="p-5">
    <p>How It Work.</p>
    <h6>It Was Great Pleasure To Use Self Drive Service. I Hired Mercedes E Class From Greater Noida To Anywhere And It Was Awesome Experienced. The Car Condition Of Self Drive Were Excellent And I Will Use Self Drive Service Again Because The Rate Given On Reasonable Price. 

Deep Nainiwal.</h6>
    <div class="my-4" data-aos="fade-down" data-aos-duration="1000">
      <p>
        <i class="fa-solid fa-car fa-2x"></i> <br /> <label>Selfdriver Rent A Car.</label>
      </p>
      <p>
        <i class="fa-solid fa-car-side fa-2x"></i> <br /> <label>Drive Anywhere.</label>
      </p>
      <p>
        <i class="fa-solid fa-key fa-2x"></i> <br /> <label>Delivery.</label>
      </p>
      <p class="border-0">
        <i class="fa-regular fa-id-card fa-2x"></i> <br /> <label>Return Car.</label>
      </p>
    </div>
  ...
  <section id="gallery" class="container my-5">
    <h3 class="mb-4">Beautiful Glimpse of Travels And Cars.</h3>
  ...
  <section class="container-fluid">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7015.873108837287!2d77.50102586375745!3d28.451328890415503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cc1c4536ee66f%3A0x12c712ec21f8b972!2sMitra%20Enclave%2C%20Greater%20Noida%2C%20Uttar%20Pradesh%20201310!5e0!3m2!1sen!2sin!4v1701610019697!5m2!1sen!2sin" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </section>
  <footer class="bg-dark p-5 text-center">
    ...
    <p>
      <a href="https://www.facebook.com/profile.php?id=100037620396105"><i class="fa-brands fa-facebook"></i></a>
      <a href="https://www.instagram.com/ayush955516singh/"><i class="fa-brands fa-instagram"></i></a>
